            ...
            try
            {
                ...
                for(int i = 0; i < medCarInfoClasses.Count; i++)
                {
                    if(medCarInfoClasses[i].占床狀態 == "已占床")
                    {
                        ...
                        medCarInfoClasses[i].性別 = "HSEXC";
                        medCarInfoClasses[i].出生日期 = "PBIRTH8";
                        medCarInfoClasses[i].科別 = "PSECTC";
                        medCarInfoClasses[i].財務 = "PFINC";
                        medCarInfoClasses[i].入院日期 = "PADMDT";
                        medCarInfoClasses[i].訪視號碼 = "PVSDNO";
                        medCarInfoClasses[i].診所名稱 = "PVSNAM";
                        medCarInfoClasses[i].醫生姓名 = "PRNAM";
                        medCarInfoClasses[i].身高 = "PBHIGHT";
                        medCarInfoClasses[i].體重 = "PBWEIGHT";
                        medCarInfoClasses[i].體表面積 = "PBBSA";
                        medCarInfoClasses[i].國際疾病分類代碼1 = "HICD1";
                        medCarInfoClasses[i].疾病說明1 = "HICDTX1";
                        medCarInfoClasses[i].國際疾病分類代碼2 = "HICD2";
                        medCarInfoClasses[i].疾病說明2 = "HICDTX2";
                        medCarInfoClasses[i].國際疾病分類代碼3 = "HICD3";
                        medCarInfoClasses[i].疾病說明3 = "HICDTX3";
                        medCarInfoClasses[i].國際疾病分類代碼4 = "HICD4";
                        medCarInfoClasses[i].疾病說明4 = "HICDTX4";
                        medCarInfoClasses[i].鼻胃管使用狀況 = "NGTUBE";
                        medCarInfoClasses[i].其他管路使用狀況 = "TUBE";
                        medCarInfoClasses[i].過敏史 = "HALLERGY";
